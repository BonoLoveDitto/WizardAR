...
namespace SimpleCardDrawAndSpread_CardDictionary{
    ...
    public class CardDictionary : MonoBehaviour
    {
        ...
        public void Init()
        {
            ...
            Cards.Add(new Card() { id = cardNumber++, name = "長鼻子", score = 2, turn = 0, portion = "Nose", skill = "" }); //turn = 3
            Cards.Add(new Card() { id = cardNumber++, name = "巫婆鼻", score = 3, turn = 1, portion = "Nose", skill = "" }); //turn = 4
            Cards.Add(new Card() { id = cardNumber++, name = "豬鼻", score = 5, turn = 2, portion = "Nose", skill = "" }); //turn = 6
            Cards.Add(new Card() { id = cardNumber++, name = "伏地魔", score = 4, turn = 3, portion = "Nose", skill = "" }); //turn = 5
            Cards.Add(new Card() { id = cardNumber++, name = "厚道", score = 2, turn = 4, portion = "Chin", skill = "" }); //turn = 3
